<x-layout>
    ...
    <section class="relative py-16 px-6 lg:px-16 mb-16">
        <div class="absolute inset-0 bg-cover bg-center bg-fixed opacity-40" 
             style="background-image: url('{{ asset('site-banner.webp') }}');" 
             role="img" 
    ...
    <section class="py-5 lg:px-6 mb-16">
        <div class="flex flex-col items-center justify-center mx-auto max-w-screen-xl text-center">
            <h1 class="flex gap-2 items-baseline mb-8 text-4xl font-extrabold tracking-tight leading-tight text-blue-700 md:text-5xl lg:text-6xl">
            ...
            <div class="text-lg font-medium text-gray-700 mb-8 px-6 md:px-0">
                ...
                @can('create', App\Models\Vacancy::class)
                    <p class="text-xl font-semibold text-gray-800">Welcome back to the leading place to manage vacancies and applications!</p>
                @endcan
            ...
            <div class="flex flex-wrap justify-center gap-6">
                ...
                @can('create', App\Models\Vacancy::class)
                    <div class="transform hover:scale-105 hover:shadow-xl transition-all duration-300 ease-in-out">
                        <x-ui.link variant="light" href="{{ route('applications.index') }}" class="flex flex-col items-center gap-4 text-gray-800" aria-label="View all applications">
                    ...
                    <div class="transform hover:scale-105 hover:shadow-xl transition-all duration-300 ease-in-out">
                        <x-ui.link variant="blue" href="{{ route('vacancies.index') }}" class="flex flex-col items-center gap-4" aria-label="View all vacancies">
                    ...
                    <div class="transform hover:scale-105 hover:shadow-xl transition-all duration-300 ease-in-out">
                        <x-ui.link variant="light" href="{{ route('vacancies.create') }}" class="flex flex-col items-center gap-4" aria-label="Create a new vacancy">
                ...
                @can('apply', App\Models\Application::class)
                    <div class="transform hover:scale-105 hover:shadow-xl transition-all duration-300 ease-in-out">
                        <x-ui.link href="{{ route('vacancies.index') }}" role="button" class="flex flex-col items-center gap-4 " variant="blue" aria-label="Browse available vacancies">
                ...
                @guest
                <div class="transform hover:scale-105 hover:shadow-xl transition-all duration-300 ease-in-out">
                    <x-ui.link href="{{ route('vacancies.index') }}" role="button" class="flex flex-col items-center gap-4" variant="blue" aria-label="Start your job search journey">
