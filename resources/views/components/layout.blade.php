    ...
    <header>
        ...
        <x-ui.nav class="bg-slate-50">
            ...
            <x-ui.nav.title class="flex items-center">
                <img src={{ asset('VP-logo.png') }} alt="Logo" class="h-10 w-auto">
                <span>VacancyPal</span>
            </x-ui.nav.title>
            <!-- page links -->
            <x-slot:center>
                <x-ui.nav.link variant="nav" href="{{ route('home') }}">Home</x-ui.nav.link>
                <x-ui.nav.link variant="nav" href="{{ route('vacancies.index') }}">Vacancies</x-ui.nav.link>
                <x-ui.nav.link variant="nav" href="{{ route('applications.index') }}">Applications</x-ui.nav.link>
            </x-slot:center>
